  ...
  return (
    <div style={{ backgroundColor: '#f2f2f2' }}>
      ...
      <Container>
        ...
        <Paper
          p="xl"
          style={{ height: '394px', width: '100%', backgroundColor: '#f2f2f2' }}
        >
          <Flex
            direction="row"
            justify="center"
        ...
        >
          ...
          <Center style={{ height: '100%' }}>
            <Image
              src="https://digitalassets-retail.cdn-apple.com/retail-image-server/95c/16e/c24/8c7/1ff/f85/752/05f/b8c/58e/4a57e354-cd2a-3794-8a89-094a89116c16_Retail-LP-Carrier-Banner-L-2x_large_1x.png"
              alt="image"
            />
          </Center>
        </Paper>
        ...
        >
          <div style={{ backgroundColor: 'white' }}>
            ...
            >
              ...
              />
              <Title order={2}>Pay monthly at 0% APR</Title>
              <Title order={2}>when you choose to check</Title>
              <Title order={2}>out with Apple Card Monthly</Title>
              <Title order={2}>Installments.2</Title>
          ...
          <div style={{ backgroundColor: 'white' }}>
            ...
            >
              ...
              />
              <Title order={2}>We&apos;ll help you find a carrier</Title>
              <Title order={2}>plan and activate your new</Title>
              <Title order={2}>iPhone in person</Title>
            </Flex>
          </div>
        </SimpleGrid>
        ...
        >
          <Card style={{ float: 'left', width: '50%', height: '100%' }}>
            ...
            >
              ...
              <Title order={2}>Get expert service and support at</Title>
              <Title order={2}>the Genius Bar</Title>
        ...
        >
          ...
          <Card>
            ...
            >
              ...
              <Title order={2}>Put our Small Business Team on</Title>
              <Title order={2}>your team.</Title>
          ...
          <div style={{ backgroundColor: 'white' }}>
            <Card shadow="sm" radius="md" withBorder>
              ...
              >
                ...
                <Title order={2}>
                  Drop by the Apple Store to learn more about privacy features
                  on iPhone
                </Title>
          ...
          <div style={{ backgroundColor: 'white' }}>
            <Card shadow="sm" radius="md" withBorder>
              ...
              >
                <Text>News</Text>
                <Title order={2}>
                  We&apos;re going carbon neutral across our entire business by
                  2030.
                </Title>
                <Anchor style={{ marginTop: '35px' }} href="#">
                  Learn more &gt;{' '}
                </Anchor>
              </Flex>
            </Card>
